...
@MainActor
final class SingleInstanceLayer1Tests: XCTestCase {
    ...
    func testPlatformPresentNumericData_L1_SingleInstance() {
        ...
        XCTAssertNotNil(view, "Single numeric data should create a view")
        
        // Test that the view can be hosted (functional test)
        let hostingView = hostRootPlatformView(view.withGlobalAutoIDsEnabled())
        XCTAssertNotNil(hostingView, "Single numeric data view should be hostable")
    }
    
    func testPlatformPresentNumericData_L1_SingleInstance_Consistency() {
        // GIVEN: A single GenericNumericData item
        let singleNumericData = GenericNumericData(
            value: 42.0,
            label: "Test Value",
        ...
        XCTAssertNotNil(singleView, "Single instance should create a view")
        XCTAssertNotNil(arrayView, "Array version should create a view")
        ...
        XCTAssertNotNil(singleHostingView, "Single instance view should be hostable")
        XCTAssertNotNil(arrayHostingView, "Array version view should be hostable")
    }
    
    // MARK: - Single Instance Media Data Tests
    
    func testPlatformPresentMediaData_L1_SingleInstance() {
        ...
        // THEN: Should create a view successfully
        XCTAssertNotNil(view, "Single media item should create a view")
        
        // Test that the view can be hosted (functional test)
        let hostingView = hostRootPlatformView(view.withGlobalAutoIDsEnabled())
        XCTAssertNotNil(hostingView, "Single media item view should be hostable")
    }
    
    // MARK: - Single Instance Hierarchical Data Tests
    
    func testPlatformPresentHierarchicalData_L1_SingleInstance() {
        ...
        // THEN: Should create a view successfully
        XCTAssertNotNil(view, "Single hierarchical item should create a view")
        
        // Test that the view can be hosted (functional test)
        let hostingView = hostRootPlatformView(view.withGlobalAutoIDsEnabled())
        XCTAssertNotNil(hostingView, "Single hierarchical item view should be hostable")
    }
    
    // MARK: - Single Instance Temporal Data Tests
    
    func testPlatformPresentTemporalData_L1_SingleInstance() {
        ...
        // THEN: Should create a view successfully
        XCTAssertNotNil(view, "Single temporal item should create a view")
        
        // Test that the view can be hosted (functional test)
        let hostingView = hostRootPlatformView(view.withGlobalAutoIDsEnabled())
        XCTAssertNotNil(hostingView, "Single temporal item view should be hostable")
    }
    
    // MARK: - Single Instance Form Data Tests
    
    func testPlatformPresentFormData_L1_SingleInstance() {
        ...
        XCTAssertNotNil(view, "Single form field should create a view")
        
        // Test that the view can be hosted (functional test)
        let hostingView = hostRootPlatformView(view.withGlobalAutoIDsEnabled())
        XCTAssertNotNil(hostingView, "Single form field view should be hostable")
    }
    
    // MARK: - Edge Cases
    
    func testSingleInstanceFunctions_WithDifferentHints() {
        ...
        // THEN: Both should create views successfully
        XCTAssertNotNil(cardView, "Card presentation should create a view")
        XCTAssertNotNil(listView, "List presentation should create a view")
        ...
        XCTAssertNotNil(cardHostingView, "Card view should be hostable")
        XCTAssertNotNil(listHostingView, "List view should be hostable")
    }
}
