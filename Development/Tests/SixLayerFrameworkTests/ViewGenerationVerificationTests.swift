...
final class ViewGenerationVerificationTests: XCTestCase {
    ...
    func testTouchPlatformViewGeneration() {
    ...
    func testHoverPlatformViewGeneration() {
    ...
    func testTouchHoverPlatformViewGeneration() {
    ...
    func testAccessibilityOnlyPlatformViewGeneration() {
    ...
    func testVisionPlatformViewGeneration() {
    ...
    func testReduceMotionViewGeneration() {
    ...
    func testIncreaseContrastViewGeneration() {
    ...
    func testBoldTextViewGeneration() {
    ...
    func testLargerTextViewGeneration() {
    ...
    func testMacWithTouchDisplayAndAllAccessibility() {
    ...
    func testIPhoneWithNoAccessibility() {
