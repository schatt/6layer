...
- **Generated**: 2025-09-01 09:01:38 -0700
...
### Public Interface
- **L43:** ` public func nextStep() -> Bool`
  - *function*
  - *Move to the next step if validation passes\n*
- **L56:** ` public func previousStep() -> Bool`
  - *function*
  - *Move to the previous step\n*
- **L63:** ` public func canProceedToNextStep() -> Bool`
  - *function*
  - *Check if we can proceed to the next step\n*
- **L74:** ` public func isStepComplete(_ stepId: String) -> Bool`
  - *function*
  - *Check if a specific step is complete\n*
- **L79:** ` public func markStepComplete(_ stepId: String)`
  - *function*
  - *Mark a step as complete\n*
- **L84:** ` public func getCurrentStep() -> FormWizardStep?`
  - *function*
  - *Get the current step\n*
- **L93:** ` public func setSteps(_ newSteps: [FormWizardStep])`
  - *function*
  - *Set the steps for this wizard\n*
- **L110:** ` public func clearValidationErrors(for stepId: String)`
  - *function*
  - *Clear validation errors for a step\n*
- **L115:** ` public func addValidationError(_ error: String, for stepId: String)`
  - *function*
  - *Add validation error for a step\n*
- **L157:** ` public func build() -> [FormWizardStep]`
  - *function*
...
### Public Interface
- **L197:** ` public static func shouldOverrideFramework(`
  - *static function*
  - *Process hints to determine if they should override framework defaults\n*
- **L205:** ` public static func extractLayoutPreferences(`
  - *static function*
  - *Extract layout preferences from hints\n*
- **L227:** ` public static func extractPerformancePreferences(`
  - *static function*
  - *Extract performance preferences from hints\n*
- **L248:** ` public static func extractAccessibilityPreferences(`
  - *static function*
...
### Public Interface
- **L25:** ` public func trackFormView(formId: String, userId: String? = nil)`
  - *function*
  - *Track form view event\n*
- **L39:** ` public func trackFormSubmission(formId: String, userId: String? = nil, success: Bool, validationErrors: [String] = [])`
  - *function*
  - *Track form submission event\n*
- **L57:** ` public func trackFieldInteraction(formId: String, fieldId: String, userId: String? = nil, interactionType: FieldInteractionType)`
  - *function*
  - *Track field interaction event\n*
- **L74:** ` public func trackPerformance(formId: String, metrics: FormPerformanceMetrics)`
  - *function*
  - *Track form performance metrics\n*
- **L82:** ` public func trackError(formId: String, error: FormError)`
  - *function*
  - *Track form error\n*
- **L92:** ` public func startABTest(formId: String, variantA: FormVariant, variantB: FormVariant) -> ABTest`
  - *function*
  - *Start A/B test for a form\n*
- **L110:** ` public func recordABTestResult(testId: String, variant: String, result: ABTestMetric)`
  - *function*
  - *Record A/B test result\n*
- **L127:** ` public func getAnalytics(for formId: String) -> FormAnalytics?`
  - *function*
  - *Get analytics for a specific form\n*
- **L132:** ` public func getPerformanceMetrics(for formId: String) -> FormPerformanceMetrics?`
  - *function*
  - *Get performance metrics for a form\n*
- **L137:** ` public func getFormInsights(formId: String) -> FormInsights`
  - *function*
  - *Get form insights and recommendations\n*
- **L235:** ` public func calculateCompletionRate() -> Double`
  - *function*
- **L243:** ` public func calculateAverageCompletionTime() -> TimeInterval`
  - *function*
- **L291:** ` public func encode(to encoder: Encoder) throws`
  - *function*
- **L438:** ` public func encode(to encoder: Encoder) throws`
  - *function*
...
- **L351:** ` public init(formId: String, averageRenderTime: TimeInterval, averageValidationTime: TimeInterval, memoryUsage: Int64, cpuUsage: Double)`
  - *function*
- **L373:** ` public init(formId: String, fieldId: String? = nil, type: FormErrorType, message: String, stackTrace: String? = nil)`
  - *function*
- **L404:** ` public init(id: String, formId: String, variantA: FormVariant, variantB: FormVariant, startDate: Date, status: ABTestStatus)`
  - *function*
- **L420:** ` public init(name: String, configuration: [String: Any], description: String)`
  - *function*
- **L431:** ` public init(from decoder: Decoder) throws`
  - *function*
- **L462:** ` public init(testId: String, variant: String, metric: ABTestMetric, timestamp: Date)`
  - *function*
- **L476:** ` public init(name: String, value: Double, unit: String)`
  - *function*
- **L493:** ` public init(formId: String, analytics: FormAnalytics?, performance: FormPerformanceMetrics?, errors: [FormError], recommendations: [FormRecommendation])`
  - *function*
- **L510:** ` public init(type: FormRecommendationType, title: String, description: String, priority: FormRecommendationPriority)`
  - *function*

### Internal Methods
- **L546:** ` func saveAnalytics(_ analytics: FormAnalytics, for formId: String)`
  - *function*
- **L552:** ` func loadAllAnalytics() -> [String: FormAnalytics]`
  - *function*
- **L556:** ` func savePerformanceMetrics(_ metrics: FormPerformanceMetrics, for formId: String)`
  - *function*
- **L562:** ` func loadAllPerformanceMetrics() -> [String: FormPerformanceMetrics]`
  - *function*
- **L566:** ` func saveError(_ error: FormError)`
  - *function*
- **L572:** ` func loadAllErrors() -> [FormError]`
  - *function*
- **L576:** ` func saveABTest(_ test: ABTest)`
  - *function*
- **L582:** ` func loadAllABTests() -> [String: ABTest]`
  - *function*
- **L586:** ` func saveABTestResult(_ result: ABTestResult)`
  - *function*
- **L592:** ` func loadAllABTestResults() -> [ABTestResult]`
  - *function*
...
### Public Interface
- **L84:** ` public static func platformDecimalKeyboardType() -> KeyboardType`
  - *static function*
...
### Public Interface
- **L185:** ` public func getField(by id: String) -> DynamicFormField?`
  - *function*
  - *Get field by ID\n*
- **L190:** ` public func getSection(by id: String) -> DynamicFormSection?`
  - *function*
  - *Get section by ID\n*
- **L225:** ` public func hasErrors(for fieldId: String) -> Bool`
  - *function*
  - *Check if field has errors\n*
- **L230:** ` public func getErrors(for fieldId: String) -> [String]`
  - *function*
  - *Get errors for a specific field\n*
- **L235:** ` public func addError(_ error: String, for fieldId: String)`
  - *function*
  - *Add error for a specific field\n*
- **L243:** ` public func clearErrors(for fieldId: String)`
  - *function*
  - *Clear errors for a specific field\n*
- **L248:** ` public func clearAllErrors()`
  - *function*
  - *Clear all errors\n*
- **L253:** ` public func isSectionCollapsed(_ sectionId: String) -> Bool`
  - *function*
  - *Check if section is collapsed\n*
- **L258:** ` public func toggleSection(_ sectionId: String)`
  - *function*
  - *Toggle section collapsed state\n*
- **L268:** ` public func reset()`
  - *function*
